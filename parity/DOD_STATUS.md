...
| Tier 1 functional/filter/sub-view checklist >= 95% per view | PARTIAL | `spec/requests/issues_spec.rb`, `spec/requests/users_spec.rb`, `PROGRESS.md`, `parity/SCORE_HISTORY.md` | Shared list filters now persist via URL state for Team Issues/My Issues. Remaining score gaps to `95`: functional `0`, filter `3`, sub-view `3`. |
...
- Filter parity: `92` (`gap: 3`)
- Sub-view parity: `92` (`gap: 3`)
